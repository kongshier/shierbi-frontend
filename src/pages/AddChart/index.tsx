              ...
              >
                <Select
                  options={[
                    ...
                    { value: '数据集', label: '数据集' },
                    { value: '区域图', label: '区域图' },
                    { value: '多雷达图', label: '多雷达图' },
                    { value: '3D 地图', label: '3D 地图' },
                    { value: '3D 曲面', label: '3D 曲面' },
                    { value: '3D 柱状图', label: '3D 柱状图' },
                    { value: '3D 散点图', label: '3D 散点图' },
                    { value: '3D 折线图', label: '3D 折线图' },
                    { value: 'GL 散点图', label: 'GL 散点图' },
                    { value: 'GL 关系图', label: 'GL 关系图' },
                    { value: '平行坐标系', label: '平行坐标系' },
                    { value: '圆角环形图', label: '圆角环形图' },
                    { value: '大数据量柱图', label: '大数据量柱图' },
                    { value: '动态排序柱状图', label: '动态排序柱状图' },
                    { value: '极坐标柱状图标签', label: '极坐标柱状图标签' },
                  ]}
                ></Select>
              </Form.Item>
